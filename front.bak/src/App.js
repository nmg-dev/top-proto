...
import { Card, CardHeader, Icon, CardContent, CardActions, AppBar, Toolbar, Grid, Paper, Button } from '@material-ui/core';
		...
		return(
			<AppBar position="sticky" style={styles.appbar}>
				<Toolbar style={styles.toolbar}>
					...
					<div style={styles.toolbarItem}>
						<Button style={styles.viewButton} onClick={()=>this.setState({view: viewIndex})}>{this.lang.tr(viewIndex)}</Button>
						<Button style={styles.viewButton} onClick={()=>this.setState({view: viewInfo})}>{this.lang.tr(viewInfo)}</Button>
