<template>
    <b-input-group>
        ...
        <b-form-input type="text" readonly :value="`${momentFrom} - ${momentTill}`" ></b-form-input>
        <b-input-group-append>
            <b-dropdown right ref="caldrop">
                <b-dropdown-form>
                    <b-input-group>
                        <b-input-group-prepend>
                            <b-button disabled><i class="fas fa-calendar" /></b-button>
                        </b-input-group-prepend>
                        ...
                        <b-input-group-append>
                            <b-button variant="primary" @click="submitPeriod"><i class="fas fa-check" /></b-button>
                        </b-input-group-append>
                    </b-input-group>
                    <b-input-group>
                        <b-input-group-prepend>
